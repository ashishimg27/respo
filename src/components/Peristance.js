...
const Peristance= () => {
  ...
  return (
    <div>
      <CssBaseline />
      <Drawer open={open} variant='persistent' onClose={() => setOpen(false)}>
      ...
      <AppBar position="static" color="secondary" className ={classNames({[classes.appbarShift]:open})} >
        <Toolbar>
          <IconButton
            edge="start"
